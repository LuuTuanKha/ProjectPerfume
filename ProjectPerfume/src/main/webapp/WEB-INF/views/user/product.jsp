...
<html lang="zxx">
<head>
	<title>Sản phẩm | Áo dài cách tân</title>
	<meta charset="UTF-8">
...
<body>
					...
					<div class="col-xl-4 col-lg-5">
						<div class="user-panel">
							<div class="up-item">
								...
								<a href="./index_login.html">Đăng nhập </a>Hoặc<a href="./index_signup.html"> Đăng ký</a>
							</div>
							<div class="up-item">
				...
				<ul class="main-menu">
					...
					<li><a href="#">Giày</a>
						<ul class="sub-menu">
							...
							<li><a href="#">Giày sang trọng</a></li>
					...
					<li><a href="#">Xem thêm</a>
						<ul class="sub-menu">
							...
							<li><a href="./cart.html">Thẻ thành viên</a></li>
	...
	<section class="product-section">
		<div class="container">
			<div class="back-link">
				<a href="./category.html"> &lt;&lt; Quay lại mua sắm</a>
			</div>
			<div class="row">
				<div class="col-lg-6">
